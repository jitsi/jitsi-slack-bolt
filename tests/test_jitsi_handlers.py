...
class TestJitsiHandlers:
    ...
    def test_slash_jitsi_server_view(self, workspace_store, mock_command):
        ...
        # Assert
        self.respond.assert_called_once_with("Your team's conferences are hosted at: https://meet.example.com/")
    ...
    def test_slash_jitsi_server_set_default(self, workspace_store, mock_command):
        ...
        assert workspace_store.get_workspace_server_url(command["team_id"]) == self.default_server_url
    ...
    def test_slash_jitsi_server_set_custom(self, workspace_store, mock_command):
        ...
        assert workspace_store.get_workspace_server_url(command["team_id"]) == "https://meet.custom.com/"
